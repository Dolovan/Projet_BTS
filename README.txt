...
## Méthodes
 ...
 ChargerEnvironnementsIdentifiables_depuisXML(string fichier)

	Exemple:
	ChargerEnvironnementsIdentifiables_depuisXML(@"..\..\..\..\fichiers_XML\EnvironnementsIdentifiables.xml");

ChargerEnvironnementsIdentifiables_depuisXmlDocument();
